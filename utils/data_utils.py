...
def get_transforms(dataset, large_res=False):
...
def get_dataloader(dataset, train_batch_size, test_batch_size, num_workers=2, root='../data', large_res=False):
    transform_train, transform_test = get_transforms(dataset, large_res=large_res)

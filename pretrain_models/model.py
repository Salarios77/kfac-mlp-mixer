...
import pretrain_models.configs as configs
...
class MlpMixer(nn.Module):
    ...
    def forward(self, x, labels=None):
        ...
        x = self.stem(x)
        # print(f"after conv2d input size:{x.size()}")
...
CONFIGS = {
    'Mixer-S_4': configs.get_mixer_s4_config(),
    'Mixer-S_16': configs.get_mixer_s16_config(),
    'Mixer-B_4': configs.get_mixer_b4_config(),
